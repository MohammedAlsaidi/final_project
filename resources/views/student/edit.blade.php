...
<div class="container">
  ...
  <form  method="POST" action="{{route('student.update',$students->id)}}" class="form-horizontal"  enctype="multipart/form-data">>
  @csrf
  @method('PUT')
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="password" class="form-control" placeholder="identity" name="identity">
      </div>
    </div>
    <div class="form-group">        
